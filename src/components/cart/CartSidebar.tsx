...
export default function CartSidebar() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      {/* Cart Drawer */}
      <div className="relative w-full max-w-md bg-[#F4F1EA] h-full shadow-2xl flex flex-col transform transition-transform duration-300 border-l border-[#D4A373]/30">
        ...
        {items.length > 0 && (
          <div className="p-8 bg-[#F9F7F2] border-t border-[#D4A373]/20">
            ...
            >
              {currentLang === 'ar' ? "إتمام الطلب" : 
               currentLang === 'fr' ? "PASSER LA COMMANDE" : 
               "PROCEED TO CHECKOUT"}
            </Link>
